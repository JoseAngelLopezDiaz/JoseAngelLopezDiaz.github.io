...
{{% blocks/feature
  title="Me encanta el ajedrez" icon="fas fa-chess-knight"%}}
...
{{% blocks/feature
  title="Pulsa [aquí](https://www.youtube.com/watch?v=YqVRcFQagtI&list=RDYqVRcFQagtI&start_radio=1) para una mejor expreiencia" icon="fas fa-music"%}}
